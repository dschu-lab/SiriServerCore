...
class wolfram(Plugin):
    ...
    def wolfram(self, speech, language, regex):
        ...
        if wolfram_pod0 != 12:
            # I found it
            if language == 'de-DE':
                rep = [u"Dies könnte deine Frage beantworten:", u"Ich glaube, ich habe was für dich gefunden:", u"Werf mal einen Blick hier drauf:", u"Das könnte dir weiterhelfen:", u"Vielleicht hilft dir das weiter:", u"Tadaa:",]
        ...
        if wolfram_pod0 == 12:
            if language == 'de-DE':
                self.say("Es tut mir leid. Ich konnte keine Antwort auf deine Frage finden.")
            elif language == 'fr-FR':
