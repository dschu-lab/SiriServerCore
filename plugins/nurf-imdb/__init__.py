...
#------------------------------
#Recommend using rt (rotten tomatoes) plugin instead. Do not enter both in plugins.conf!
#------------------------------
...
class nurf_imdb(Plugin):
    ...
    @register("de-DE", u"(regie bei)* ([\w ]+)")
    @register("en-GB", "(who directed)* ([\w ]+)") 
    @register("en-US", "(who directed)* ([\w ]+)")
    def get_director(self, speech, language,  regex):
        if language == "en-GB" or language == "en-US" or language == "de-DE":
    ...
    @register("de-DE",  "(wer spielte|wer spielte|wer war)* ([\w ]+) *in* ([\w ]+)")
    @register("en-GB",  "(who played|who plays|who was)* ([\w ]+) *in* ([\w ]+)")
    ...
    @register("de-DE",  "(film suche|suche film|suche spielfilm|spielfilm suche)* ([\w ]+)")
    @register("en-GB",  "(movie lookup|lookup movie|lookup film|film lookup|movie look up|look up movie|look up film|film look up|search.*film|search.*movie)* ([\w ]+)")
    @register("en-US",  "(movie lookup|lookup movie|lookup film|film lookup|movie look up|look up movie|look up film|film look up|search.*film|search.*movie)* ([\w ]+)")
    ...
    @register("de-DE", "(sollte ich)* ([\w ]+).*(sehen|ansehen)")
    @register("en-GB", "(should i see|should i watch)* ([\w ]+)")
